...
export default function HomePageContent() {
  ...
  return (
    <>
      ...
      <Section id="uvp" className="!bg-white" noPadding containerClassName="py-24 md:py-32">
        ...
        <CardSlider desktopClassName="md:grid md:grid-cols-3 gap-8" mobileItemWidth="w-[85vw] sm:w-[350px]">
          {homeUVP.map((uvp, idx) => {
            const Icon = uvp.icon;
            return (
              <SpotlightCard key={idx} className="h-full rounded-3xl border border-slate-200 bg-white dark:border-slate-700 dark:bg-slate-900" spotlightColor="rgba(37, 99, 235, 0.1)">
        ...
        <Grid cols={12} gap={6} className="relative z-10 items-stretch">
          ...
          >
            ...
            <SpotlightCard className="h-full rounded-3xl border-red-200 dark:border-red-900" spotlightColor="rgba(239, 68, 68, 0.1)">
              <div className="flex h-full flex-col p-8">
                <Stack direction="horizontal" justify="between" className="mb-6">
                  <span className="rounded-full bg-slate-100 px-3 py-1 text-[10px] font-bold tracking-wider text-slate-500 uppercase dark:bg-slate-800 dark:text-slate-400">Problem #1</span>
                ...
                <div className="mt-auto">
                  <Stack direction="vertical" gap={3} className="mb-6 border-b border-slate-200 pb-4 dark:border-slate-700">
            ...
            <SpotlightCard className="h-full rounded-3xl border-amber-200 dark:border-amber-900" spotlightColor="rgba(245, 158, 11, 0.1)">
              <div className="flex h-full flex-col p-8">
                <Stack direction="horizontal" justify="between" className="mb-6">
                  <span className="rounded-full bg-slate-100 px-3 py-1 text-[10px] font-bold tracking-wider text-slate-500 uppercase dark:bg-slate-800 dark:text-slate-400">Problem #2</span>
            ...
            return (
              <Link key={ind.id} href={`/solutions/${ind.id}`} className="group block h-full">
                <SpotlightCard className="h-full rounded-3xl" spotlightColor="rgba(37, 99, 235, 0.1)">
                  <div className="flex h-full flex-col p-8">
                    <Stack direction="horizontal" gap={4} align="center" justify="center" className="mb-6 h-12 w-12 rounded-xl bg-slate-100 text-slate-600 transition-colors duration-300 group-hover:bg-blue-600 group-hover:text-white dark:bg-slate-800 dark:text-slate-400 dark:group-hover:bg-blue-600 dark:group-hover:text-white">
                      <Icon className="h-6 w-6" aria-hidden="true" />
                    </Stack>
                    <h3 className="mb-3 text-xl font-bold text-slate-900 group-hover:text-blue-600 dark:text-white dark:group-hover:text-blue-400">{ind.title}</h3>
                    <p className="mb-4 flex-grow text-sm leading-relaxed text-slate-600 dark:text-slate-400">{ind.description}</p>
                    <Stack direction="horizontal" gap={4} align="center" className="-translate-x-2 text-sm font-bold text-blue-600 opacity-0 transition-all duration-300 group-hover:translate-x-0 group-hover:opacity-100 dark:text-blue-400">
                      Explore
                      {' '}
              ...
              <Link key={role.id} href={`/role/${role.id}`} className="group block h-full">
                <SpotlightCard className="h-full rounded-2xl text-center" spotlightColor="rgba(59, 130, 246, 0.1)">
                  <div className="flex h-full flex-col items-center p-6">
                    <Stack direction="horizontal" gap={4} align="center" justify="center" className="mx-auto mb-3 h-10 w-10 rounded-full bg-blue-50 text-blue-600 transition-all duration-300 group-hover:scale-110 group-hover:bg-blue-600 group-hover:text-white dark:bg-blue-950 dark:text-blue-400 dark:group-hover:bg-blue-600 dark:group-hover:text-white">
      ...
      {/* 9. INTEGRATIONS */}
      <Section id="integrations" className="border-y border-slate-200 !bg-slate-50 dark:border-slate-800 dark:!bg-slate-900" noPadding containerClassName="py-24 md:py-32">
        ...
        <div className="max-w-full overflow-hidden">
          <InfiniteScrollLoop speed={40} direction="right">
            {homeIntegrations.map((int, idx) => (
              <div key={idx} className="mx-2 flex cursor-default items-center gap-3 rounded-full border border-slate-200 bg-white px-6 py-3 whitespace-nowrap shadow-sm transition-all duration-300 hover:border-blue-200 hover:shadow-lg dark:border-slate-700 dark:bg-slate-800 dark:hover:border-blue-600">
                <div className="text-xs font-bold tracking-wider text-slate-400 uppercase dark:text-slate-500" aria-hidden="true">{int.icon}</div>
        ...
        <div className="mt-12 text-center">
          <Link href="/platform/technologies/integration" className="inline-flex items-center gap-2 font-bold text-blue-600 transition-colors hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">
