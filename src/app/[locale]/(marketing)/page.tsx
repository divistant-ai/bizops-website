...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <div className="relative overflow-hidden bg-white pt-32 pb-20 lg:pt-48 lg:pb-32">
        ...
        <Container size="7xl" className="relative z-10 text-center">
          ...
          <FadeIn delay={0.1} className="mb-8 inline-flex w-full justify-center">
            <div className="group inline-flex cursor-pointer items-center gap-3 rounded-full border border-slate-200/60 bg-white px-5 py-2.5 shadow-[0_2px_8px_rgba(0,0,0,0.04)] transition-all duration-300 hover:border-blue-200 hover:shadow-[0_4px_12px_rgba(0,0,0,0.06)]">
              <span className="relative flex h-2 w-2">
                <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-blue-400 opacity-75"></span>
                <span className="relative inline-flex h-2 w-2 rounded-full bg-blue-600"></span>
              </span>
              <span className="text-sm font-semibold text-slate-600 transition-colors group-hover:text-blue-700">
                {t('announcement')}
              </span>
          ...
          <div className="mx-auto mb-8 max-w-6xl">
            <FadeIn delay={0.2}>
              <h1 className="text-5xl leading-[1.1] font-bold tracking-tight text-slate-900 md:text-7xl lg:text-8xl">
                {t('hero_title_prefix')}
                <span className="mt-2 block bg-gradient-to-r from-slate-900 via-blue-700 to-blue-600 bg-clip-text pb-4 text-transparent">
          ...
          {/* Subheadline */}
          <FadeIn delay={0.3}>
            <p className="mx-auto mb-12 max-w-3xl text-xl leading-relaxed font-normal text-slate-500 md:text-2xl">
              {t('hero_description')}
            </p>
          </FadeIn>
          ...
          <FadeIn delay={0.4}>
            <div className="mb-20 flex flex-col justify-center gap-4 sm:flex-row">
              <Button asChild size="lg" variant="primary" className="h-14 rounded-full bg-blue-600 px-10 text-lg font-semibold text-white shadow-xl shadow-blue-900/10 transition-all duration-300 hover:-translate-y-0.5 hover:bg-blue-700 hover:shadow-blue-900/20">
                <Link href="/demo">{t('cta_demo')}</Link>
              </Button>
              <Button asChild size="lg" variant="outline" className="h-14 rounded-full border-slate-200 bg-white px-10 text-lg font-medium text-slate-700 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:bg-slate-50 hover:text-slate-900">
                <Link href="/pricing-calculator">
                  <Calculator className="mr-2 h-5 w-5 text-slate-400 group-hover:text-slate-600" />
                  {' '}
                  {t('cta_pricing')}
                </Link>
              </Button>
      ...
      {/* 2. PROBLEMS SECTION */}
      <Section id="problems" className="relative overflow-hidden !bg-slate-50" noPadding containerClassName="py-24 md:py-32">
        <div
      ...
      <Section id="uvp" className="!bg-white" noPadding containerClassName="py-24 md:py-32">
        ...
        <CardSlider desktopClassName="md:grid md:grid-cols-3 gap-8" mobileItemWidth="w-[85vw] sm:w-[350px]">
          {homeUVP.map((uvp, idx) => {
            const Icon = uvp.icon;
            return (
              <SpotlightCard key={idx} className="h-full rounded-3xl bg-slate-50" spotlightColor="rgba(37, 99, 235, 0.1)">
                <div className="relative flex h-full flex-col p-8">
                  ...
                  <div className="relative z-10 flex-grow">
                    <Stack direction="horizontal" gap={4} align="center" justify="center" className="mb-6 h-14 w-14 rounded-2xl bg-white text-blue-600 shadow-sm ring-1 ring-slate-100 transition-colors duration-300 group-hover:bg-blue-600 group-hover:text-white">
      ...
      <Section id="pricing-comparison" className="relative overflow-hidden border-t border-slate-200 !bg-slate-50" noPadding containerClassName="py-24 md:py-32">
      ...
      {/* 7. INDUSTRIES & ROLES */}
      <Section id="industries" className="!bg-white" noPadding containerClassName="py-24 md:py-32">
          ...
          <div className="relative mt-8 md:mt-0">
            ...
            <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-slate-900/80 p-8 backdrop-blur-xl">
              ...
              <Stack direction="vertical" gap={4}>
                ...
                <BarChart bars={40} minHeight={30} maxHeight={80} />
