  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-white transition-colors duration-300">
      ...
      <div className="mt-6 text-center">
        <h3 className="text-lg font-bold tracking-tight text-slate-900">BizOps</h3>
        <p className="mt-1 animate-pulse text-xs tracking-widest text-slate-500 uppercase">Loading Environment</p>
      </div>
    </div>
  );
});
